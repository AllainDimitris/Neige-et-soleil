...
CREATE TABLE IF NOT EXISTS SAISON
 (
   ...
   DATEDEBUTS INTEGER(8) NULL  ,
   DATEFINS INTEGER(8) NULL  ,
...
CREATE TABLE IF NOT EXISTS CONTRATP
 (
   ...
   DATEDEBCP INTEGER(8) NULL  ,
   DATEFINCP INTEGER(8) NULL  ,
   DATESIGNCP INTEGER(8) NULL  
...
CREATE TABLE IF NOT EXISTS CLIENT
 (
   ...
   IdentifiantCL varchar(20) not null,
...
CREATE TABLE IF NOT EXISTS RESERVATION
 (
   ...
   IDS INTEGER(4) NOT NULL  ,
   DATEDEBUTR INTEGER(8) NULL  ,
   DATEFINR INTEGER(8) NULL  ,
...
Insert into client values (1, "HOMME", "JOJO", "Mojo", "MojoJOJO@gmail.com", "2 Rue du palais", "75017", "Paris", "0675856880", "1992/10/05", "MOJO", "aaazzeee");  
